      ...
      <div class="container pt-3">
        ...
        <div class="row pb-5">
          <div class="col-lg-6 pt-4 my-auto">
            ...
            <img id="iphone-img" src="/public/assets/travelTreasuryiPhone.png" class="img-fluig">
          </div>
            ...
            <div id="available" class="p-2">
              ...
              <div class="row">
                <div class="col my-auto">
                  <img src="public\assets\download_apple.png" class="float-right img-fluid app_store_img">
                </div>
                <div class="col my-auto">
                  <img src="/public/assets/download_google.png" class="float-left img-fluid app_store_img">
                </div>
              </div>
            </div>
    ...
    <div id="about" class="bg-light p-3 p-md-5">
      <div class="row">
        <div class="col-lg">
          ...
          <img src="/public/assets/download_apple.png" height="120" class="m-4">
        ...
        <div class="col-lg">
          ...
          <img src="/public/assets/icon/piggy-bank.svg" height="120" class="m-4">
          <h5 class="ml-md-4 mr-md-4">
        ...
        <div class="col-lg">
          <!-- Icon made by Freepik perfect from www.flaticon.com -->
          <img src="/public/assets/icon/passport.svg" height="120" class="m-4">
          <h5 class="ml-md-4 mr-md-4">
...
<style scoped>
  #home-page {
    ...
    background: url('/public/assets/bg_mt.jpg') no-repeat center center;
